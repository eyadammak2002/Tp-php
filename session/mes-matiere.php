...
<?php
if (isset($_SESSION['login']) && isset($_SESSION['pwd'])) :?> <h5>Votre login est: <?= $_SESSION['login']?></h5>
<h2>Liste des matières de Mr/Mme <?= $_SESSION["nom"]; ?></h2> <?php
$tabMat=$matieres[$_SESSION['indice']]; foreach($tabMat as $value)
          echo" $value.'<br>’";
?>
